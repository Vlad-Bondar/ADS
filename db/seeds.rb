...
Post.create(header: 'Sport 2',body: 'Sport 2',category_id: 1 ,user_id: 2,status: Post.statuses[:published])
Post.create(header: 'Sport 3',body: 'Sport 3',category_id: 1 ,user_id: 2,status: Post.statuses[:new_post])
Post.create(header: 'Sport 4',body: 'Sport 4',category_id: 1 ,user_id: 2,status: Post.statuses[:rejected])

Post.create(header: 'Car 1',body: 'Car 1',category_id: 2,user_id: 2,status: Post.statuses[:draft])
...
Post.create(header: 'Nature 3',body: 'Nature 3',category_id: 3,user_id: 2,status: Post.statuses[:published])
Post.create(header: 'Nature 4',body: 'Nature 4',category_id: 3,user_id: 1,status: Post.statuses[:new_post])

Post.create(header: 'Money 1',body: 'Money 1',category_id: 4,user_id: 2,status: Post.statuses[:approved])
Post.create(header: 'Money 2',body: 'Money 2',category_id: 4,user_id: 2,status: Post.statuses[:new_post])
Post.create(header: 'Money 3',body: 'Money 3',category_id: 4,user_id: 2,status: Post.statuses[:draft])
Post.create(header: 'Money 4',body: 'Money 4',category_id: 4,user_id: 2,status: Post.statuses[:new_post])

Post.create(header: 'Other 1',body: 'Other 1',category_id: 5,user_id: 1,status: Post.statuses[:rejected])
Post.create(header: 'Other 2',body: 'Other 2',category_id: 5,user_id: 2,status: Post.statuses[:new_post])
Post.create(header: 'Other 3',body: 'Other 3',category_id: 5,user_id: 1,status: Post.statuses[:published])
Post.create(header: 'Other 4',body: 'Other 4',category_id: 5,user_id: 2,status: Post.statuses[:archived])
